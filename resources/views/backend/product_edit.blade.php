        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mt-2">
                <div class="col-md-6">
                    ...
                    <input type="text" name="color" id="color" class="form-control" placeholder="Enter Product Color">
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6">
                    ...
                    <input type="text" name="original_price" id="original_price" class="form-control" placeholder="Enter Original Price">
                </div>
